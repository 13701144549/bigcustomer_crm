...
def format_amount(amt, currency='156', comma=True, zero=False):
    '''
    格式化我们系统中的金额
    '''

    # 最小单位是元的 不除以100 这里根据业务扩充
    if currency not in ('392', '360', '410'): # JPY IDR KRW
        amt = amt / 100.0
...
def test_format():
    print format_amount(123456)
    print format_amount(123450)
    print format_amount(123400)
    print format_amount(123456, '392')
    print format_amount(123400, '392')
    print format_amount(123456, comma=False)
    print format_amount(123400, zero=True)
