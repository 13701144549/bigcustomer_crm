...
BALANCE = {
    ...
    'hy2qf': {
        'type': '0210',
        'must': [2, 3, 7, 11, 12, 13, 15, 18, 25, 32, 33, 37, 39, 41, 42, 100],
        # 19(C0), 49(C0), 54(C3), 57(C16), 61(C16), 121(C0), 122(C0), 128(C9)
        'option': [14, 19, 49, 54, 57, 61, 121, 122, 123, 128],
    },
...
PAYMENT = {
    ...
    'hy2qf': {
        'type': '0210',
        'must': [2, 3, 4, 7, 11, 12, 13, 15, 18, 25, 32, 33, 37, 39, 41, 42, 49, 100, ],
        # 5(C14), 6(C15), 9(C14), 10(C15), 16(C14), 19(C0), 50(C14), 51(C15), 54(C25), 57(C16), 61(C16), 121(C0), 122(C0) 128(C9)
        'option': [5, 6, 9, 10, 14, 16, 19, 23, 38, 44, 50, 51, 54, 55, 57, 61, 121, 122, 123, 128],
    },
    'mac': ['MTI', 2, 3, 4, 7, 11, 18, 25, 28, 32, 33, 38, 39, 41, 42, 90],
}
