...
struct WXCustomer
{
    ...
    4: optional string follow_first_time, #  首次关注时间
    5: optional string follow_source, #  关注来源
    6: optional string follow_status, # 关注状态
}
...
service QFCustomer
{
    ...
    # =========app_local更新接口============
    # 目前只能更新follow_time
    WXCustomer wx_update(1:WXCustomer wx_customer) throws (1:CustomerError e);
    ...
    # 根据wx_appid, 和customerid获取用户的openid
    string get_openid_by_wxappid_and_customid(1: string wx_appid, 2: i32 customid) throws (1:CustomerError e);


    # 消费者登录接口
    # unionid是消费者唯一标示
    # 若存在unionid, 如果customer.openid没有对应的cid, 将新建一个消费者
    Profile login(1:WXCustomer customer, 2:Profile profile) throws (1:CustomerError e);
}
