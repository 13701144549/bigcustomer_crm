...
class Iface:
  ...
  def get_trade_fee_list(self, userids):
    """
    Parameters:
     - userids
    """
...
class Client(Iface):
  ...
  def get_trade_fee_list(self, userids):
    ...
    Parameters:
     - userids
    """
    self.send_get_trade_fee_list(userids)
    return self.recv_get_trade_fee_list()

  def send_get_trade_fee_list(self, userids):
    self._oprot.writeMessageBegin('get_trade_fee_list', TMessageType.CALL, self._seqid)
    args = get_trade_fee_list_args()
    args.userids = userids
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_get_trade_fee_list(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = get_trade_fee_list_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.e is not None:
      raise result.e
    raise TApplicationException(TApplicationException.MISSING_RESULT, "get_trade_fee_list failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["get_trade_fee_list"] = Processor.process_get_trade_fee_list
  ...
  def process_get_trade_fee_list(self, seqid, iprot, oprot):
    args = get_trade_fee_list_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = get_trade_fee_list_result()
    try:
      result.success = self._handler.get_trade_fee_list(args.userids)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except ServerException as e:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("get_trade_fee_list", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class get_account_period_args:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i165 in xrange(_size161):
            ...
            self.search_date_list.append(_elem166)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.search_date_list is not None:
      ...
      for iter167 in self.search_date_list:
...
class get_account_fee_args:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i179 in xrange(_size175):
            ...
            self.userid_list.append(_elem180)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.userid_list is not None:
      ...
      for iter181 in self.userid_list:
...
class get_feeratio_args:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i193 in xrange(_size189):
            ...
            self.out_userid_list.append(_elem194)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.out_userid_list is not None:
      ...
      for iter195 in self.out_userid_list:
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i228 in xrange(_size224):
            _elem229 = WithholdHistorySummary()
            _elem229.read(iprot)
...
class fetch_qt_bank_info_list_args:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i235 in xrange(_size231):
            ...
            self.userid_list.append(_elem236)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.userid_list is not None:
      ...
      for iter237 in self.userid_list:
...
class check_remittance_serialno_available_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i242 in xrange(_size238):
            ...
            self.serialno_list.append(_elem243)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.serialno_list is not None:
      ...
      for iter244 in self.serialno_list:
...
class get_trade_fee_list_result:
  """
  Attributes:
   - success
   - e
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(TradeFeeStruct, TradeFeeStruct.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'e', (ServerException, ServerException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_trade_fee_list_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
