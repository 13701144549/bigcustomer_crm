...
class QposDebitRecord:
  ...
  def __init__(self, name=None, bankname=None, bankaccount=None, payamt=None, status=None, expectdate=None, paydate=None, paytime=None, tradedate_start=None, tradedate_end=None, biznum=None, userid=None,):
    self.name = name
    self.bankname = bankname
    self.bankaccount = bankaccount
    self.payamt = payamt
...
class QposDebitQuery:
  ...
  thrift_spec = (
    ...
    (6, TType.LIST, 'userids', (TType.I64,None), None, ), # 6
  )

  def __init__(self, userid=None, page=None, maxnum=None, paytime_start=None, paytime_end=None, userids=None,):
    self.userid = userid
    self.page = page
    self.maxnum = maxnum
    self.paytime_start = paytime_start
  ...
  def write(self, oprot):
    ...
    if self.paytime_end is not None:
      ...
      oprot.writeFieldEnd()
    if self.userids is not None:
      oprot.writeFieldBegin('userids', TType.LIST, 6)
...
class QposDebitRecordsRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i32 in xrange(_size28):
            _elem33 = QposDebitRecord()
            _elem33.read(iprot)
            self.debit_record_list.append(_elem33)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.debit_record_list is not None:
      oprot.writeFieldBegin('debit_record_list', TType.LIST, 2)
      oprot.writeListBegin(TType.STRUCT, len(self.debit_record_list))
      for iter34 in self.debit_record_list:
        iter34.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class TradeRecordsRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i39 in xrange(_size35):
            _elem40 = AccountTradeRecord()
            _elem40.read(iprot)
            self.trade_record_list.append(_elem40)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.trade_record_list is not None:
      ...
      for iter41 in self.trade_record_list:
        iter41.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class RemittanceApprovalPara:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i46 in xrange(_size42):
            _elem47 = RemittanceRecordPara()
            _elem47.read(iprot)
            self.remittance_records.append(_elem47)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.remittance_records is not None:
      ...
      for iter48 in self.remittance_records:
        iter48.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class RemittanceApprovalRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i53 in xrange(_size49):
            _elem54 = RemittanceApproval()
            _elem54.read(iprot)
            self.remittance_approvals.append(_elem54)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.remittance_approvals is not None:
      ...
      for iter55 in self.remittance_approvals:
        iter55.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class RemittanceRecordRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i60 in xrange(_size56):
            _elem61 = RemittanceRecord()
            _elem61.read(iprot)
            self.remittance_records.append(_elem61)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.remittance_records is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.remittance_records))
      for iter62 in self.remittance_records:
        iter62.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class ApplyRechargeRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i74 in xrange(_size70):
            _elem75 = ApplyRecharge()
            _elem75.read(iprot)
            self.apply_recharge_list.append(_elem75)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.apply_recharge_list is not None:
      ...
      for iter76 in self.apply_recharge_list:
        iter76.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class UserWithholdRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i81 in xrange(_size77):
            _elem82 = UserWithhold()
            _elem82.read(iprot)
            self.user_withhold_list.append(_elem82)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.user_withhold_list is not None:
      ...
      for iter83 in self.user_withhold_list:
        iter83.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i88 in xrange(_size84):
            ...
            self.start_date.append(_elem89)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
...
class QtBankInfoRet:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i102 in xrange(_size98):
            _elem103 = QtBankInfo()
            _elem103.read(iprot)
            self.bank_info_list.append(_elem103)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.bank_info_list is not None:
      ...
      for iter104 in self.bank_info_list:
        iter104.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class BillArgsV2:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i109 in xrange(_size105):
            ...
            self.account_type.append(_elem110)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.account_type is not None:
      ...
      for iter123 in self.account_type:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i130 in xrange(_size126):
            _elem131 = UserBillItem()
            _elem131.read(iprot)
            self.bill_list.append(_elem131)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
