...
class Account:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.acct_type_id)
    return value
...
class AccountQueryArgs:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.biz_ids)
    value = (value * 31) ^ hash(self.acct_types)
    return value
...
class AccountRecordArgs:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.biz_sn)
    value = (value * 31) ^ hash(self.acct_id)
    return value
...
class AccountRecord:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.fee_ratio)
    value = (value * 31) ^ hash(self.max_fee)
...
class AccountStat:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.withdraw_amt)
    value = (value * 31) ^ hash(self.txcurrcd)
    return value
...
class AccountTypeStat:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'cnt', None, None, ), # 1
    (2, TType.I64, 'amt', None, None, ), # 2
    (3, TType.LIST, 'userids', (TType.I64,None), None, ), # 3
  )

  def __init__(self, cnt=None, amt=None, userids=None,):
    self.cnt = cnt
    self.amt = amt
    self.userids = userids
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('AccountTypeStat')
    if self.cnt is not None:
      oprot.writeFieldBegin('cnt', TType.I64, 1)
...
class Trade:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.settletn)
    value = (value * 31) ^ hash(self.title)
    value = (value * 31) ^ hash(self.detail)
    value = (value * 31) ^ hash(self.orig_biz_sn)
    value = (value * 31) ^ hash(self.chnl_code)
    value = (value * 31) ^ hash(self.qfpay_acct_id)
    value = (value * 31) ^ hash(self.acct_type_id)
    value = (value * 31) ^ hash(self.fee_amt)
    return value
...
class Transfer:
  ...
  thrift_spec = (
    ...
    (16, TType.STRING, 'chnl_code', None, None, ), # 16
  )

  def __init__(self, amt=None, txcurrcd=thrift_spec[2][4], biz_sn=None, from_userid=None, from_biz_id=None, from_acct_type_id=None, to_userid=None, to_biz_id=None, to_acct_type_id=None, sysdtm=None, title=None, detail=None, orig_biz_sn=thrift_spec[13][4], qfpay_acct_id=thrift_spec[14][4], biz_sns=None, chnl_code=None,):
    self.amt = amt
    self.txcurrcd = txcurrcd
    self.biz_sn = biz_sn
  ...
  def write(self, oprot):
    ...
    if self.biz_sns is not None:
      ...
      for iter34 in self.biz_sns:
        oprot.writeString(iter34)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.chnl_code is not None:
      oprot.writeFieldBegin('chnl_code', TType.STRING, 16)
      oprot.writeString(self.chnl_code)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.txcurrcd)
    value = (value * 31) ^ hash(self.biz_sn)
    value = (value * 31) ^ hash(self.from_userid)
    value = (value * 31) ^ hash(self.from_biz_id)
    value = (value * 31) ^ hash(self.from_acct_type_id)
    value = (value * 31) ^ hash(self.to_userid)
    value = (value * 31) ^ hash(self.to_biz_id)
    value = (value * 31) ^ hash(self.to_acct_type_id)
    value = (value * 31) ^ hash(self.sysdtm)
    value = (value * 31) ^ hash(self.title)
    value = (value * 31) ^ hash(self.detail)
    value = (value * 31) ^ hash(self.orig_biz_sn)
    value = (value * 31) ^ hash(self.qfpay_acct_id)
    value = (value * 31) ^ hash(self.biz_sns)
    value = (value * 31) ^ hash(self.chnl_code)
    return value
...
class UserCard:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.bank_brch)
    value = (value * 31) ^ hash(self.bank_area)
    value = (value * 31) ^ hash(self.bank_city)
    value = (value * 31) ^ hash(self.bank_code)
    ...
    value = (value * 31) ^ hash(self.swift_code)
    value = (value * 31) ^ hash(self.bank_addr)
...
class FeeRatio:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.ctime)
    value = (value * 31) ^ hash(self.uptime)
    value = (value * 31) ^ hash(self.is_update)
    return value
...
class IsCancelResp:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.cancel_amt)
    return value
...
class SettleCycle:
  ...
  def __init__(self, type=thrift_spec[1][4], value=None,):
    self.type = type
    self.value = value
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('SettleCycle')
...
class FundProfile:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'userid', None, None, ), # 1
    (2, TType.STRUCT, 'settle_cycle', (SettleCycle, SettleCycle.thrift_spec), None, ), # 2
    (3, TType.I32, 'settle_threshold', None, -1, ), # 3
    (4, TType.LIST, 'fee_ratio', (TType.STRUCT,(FeeRatio, FeeRatio.thrift_spec)), None, ), # 4
    (5, TType.I32, 'status', None,     1, ), # 5
  )

  def __init__(self, userid=None, settle_cycle=None, settle_threshold=thrift_spec[3][4], fee_ratio=None, status=thrift_spec[5][4],):
    self.userid = userid
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.settle_cycle = SettleCycle()
          self.settle_cycle.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
          self.settle_threshold = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('FundProfile')
    if self.userid is not None:
      oprot.writeFieldBegin('userid', TType.I64, 1)
      oprot.writeI64(self.userid)
      oprot.writeFieldEnd()
    if self.settle_cycle is not None:
      oprot.writeFieldBegin('settle_cycle', TType.STRUCT, 2)
      self.settle_cycle.write(oprot)
      oprot.writeFieldEnd()
    if self.settle_threshold is not None:
      oprot.writeFieldBegin('settle_threshold', TType.I32, 3)
      oprot.writeI32(self.settle_threshold)
      oprot.writeFieldEnd()
    if self.fee_ratio is not None:
      oprot.writeFieldBegin('fee_ratio', TType.LIST, 4)
      oprot.writeListBegin(TType.STRUCT, len(self.fee_ratio))
      for iter55 in self.fee_ratio:
        iter55.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.settle_threshold)
    value = (value * 31) ^ hash(self.fee_ratio)
