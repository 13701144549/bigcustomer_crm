...
class Iface:
  ...
  def qf_mac_gen_unionpay(self, input, mackey, zmk):
    """
    Parameters:
     - input
     - mackey
...
class Client(Iface):
  ...
  def qf_mac_gen_unionpay(self, input, mackey, zmk):
    ...
    Parameters:
     ...
     - zmk
    """
    self.send_qf_mac_gen_unionpay(input, mackey, zmk)
    return self.recv_qf_mac_gen_unionpay()

  def send_qf_mac_gen_unionpay(self, input, mackey, zmk):
    self._oprot.writeMessageBegin('qf_mac_gen_unionpay', TMessageType.CALL, self._seqid)
    args = qf_mac_gen_unionpay_args()
    args.input = input
    args.mackey = mackey
    args.zmk = zmk
    args.write(self._oprot)
  ...
  def recv_qf_mac_gen_unionpay(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = qf_mac_gen_unionpay_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "qf_mac_gen_unionpay failed: unknown result");
  ...
  def qf_gen_ztmk(self, key):
    ...
    Parameters:
     - key
    """
    self.send_qf_gen_ztmk(key)
    return self.recv_qf_gen_ztmk()

  def send_qf_gen_ztmk(self, key):
    self._oprot.writeMessageBegin('qf_gen_ztmk', TMessageType.CALL, self._seqid)
    args = qf_gen_ztmk_args()
    args.key = key
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_qf_gen_ztmk(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = qf_gen_ztmk_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "qf_gen_ztmk failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["qf_mac_gen_unionpay"] = Processor.process_qf_mac_gen_unionpay
    ...
    self._processMap["qf_gen_ztmk"] = Processor.process_qf_gen_ztmk
  ...
  def process_qf_mac_gen_unionpay(self, seqid, iprot, oprot):
    args = qf_mac_gen_unionpay_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = qf_mac_gen_unionpay_result()
    result.success = self._handler.qf_mac_gen_unionpay(args.input, args.mackey, args.zmk)
    oprot.writeMessageBegin("qf_mac_gen_unionpay", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_qf_gen_ztmk(self, seqid, iprot, oprot):
    args = qf_gen_ztmk_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = qf_gen_ztmk_result()
    result.success = self._handler.qf_gen_ztmk(args.key)
    oprot.writeMessageBegin("qf_gen_ztmk", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class qf_mac_gen_unionpay_args:
  """
  Attributes:
   - input
   - mackey
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('qf_mac_gen_unionpay_args')
    if self.input is not None:
      oprot.writeFieldBegin('input', TType.STRING, 1)
      oprot.writeString(self.input)
      oprot.writeFieldEnd()
...
class qf_mac_gen_unionpay_result:
  """
  Attributes:
   - success
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('qf_mac_gen_unionpay_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class qf_gen_ztmk_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('qf_gen_ztmk_args')
    if self.key is not None:
...
class qf_gen_ztmk_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (ZTmk, ZTmk.thrift_spec), None, ), # 0
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('qf_gen_ztmk_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
