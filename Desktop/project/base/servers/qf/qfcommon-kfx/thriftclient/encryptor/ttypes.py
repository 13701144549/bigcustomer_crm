...
class OrgKeys:
  ...
  thrift_spec = (
    ...
    (9, TType.STRING, 'zek_chcv', None, None, ), # 9
    (10, TType.STRING, 'zak_chcv', None, None, ), # 10
    (11, TType.STRING, 'zpk_chcv', None, None, ), # 11
    (12, TType.STRING, 'm_zak_z', None, None, ), # 12
    (13, TType.STRING, 'l_zak_z', None, None, ), # 13
    (14, TType.STRING, 'zak_chcv_z', None, None, ), # 14
  )

  def __init__(self, code=None, m_zpk=None, m_zak=None, m_zek=None, l_zpk=None, l_zak=None, l_zek=None, l_enc_pin_key=None, zek_chcv=None, zak_chcv=None, zpk_chcv=None, m_zak_z=None, l_zak_z=None, zak_chcv_z=None,):
    self.code = code
    self.m_zpk = m_zpk
    self.m_zak = m_zak
    self.m_zek = m_zek
    ...
    self.zek_chcv = zek_chcv
    self.zak_chcv = zak_chcv
    self.zpk_chcv = zpk_chcv
    self.m_zak_z = m_zak_z
    self.l_zak_z = l_zak_z
    self.zak_chcv_z = zak_chcv_z
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.zek_chcv = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.STRING:
          self.zak_chcv = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.STRING:
          self.zpk_chcv = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.STRING:
          self.m_zak_z = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.STRING:
          self.l_zak_z = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.STRING:
          self.zak_chcv_z = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.l_enc_pin_key is not None:
      ...
      oprot.writeFieldEnd()
    if self.zek_chcv is not None:
      oprot.writeFieldBegin('zek_chcv', TType.STRING, 9)
      oprot.writeString(self.zek_chcv)
      oprot.writeFieldEnd()
    if self.zak_chcv is not None:
      oprot.writeFieldBegin('zak_chcv', TType.STRING, 10)
      oprot.writeString(self.zak_chcv)
      oprot.writeFieldEnd()
    if self.zpk_chcv is not None:
      oprot.writeFieldBegin('zpk_chcv', TType.STRING, 11)
      oprot.writeString(self.zpk_chcv)
      oprot.writeFieldEnd()
    if self.m_zak_z is not None:
      oprot.writeFieldBegin('m_zak_z', TType.STRING, 12)
      oprot.writeString(self.m_zak_z)
      oprot.writeFieldEnd()
    if self.l_zak_z is not None:
      oprot.writeFieldBegin('l_zak_z', TType.STRING, 13)
      oprot.writeString(self.l_zak_z)
      oprot.writeFieldEnd()
    if self.zak_chcv_z is not None:
      oprot.writeFieldBegin('zak_chcv_z', TType.STRING, 14)
      oprot.writeString(self.zak_chcv_z)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class ZTmk:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'code', None, None, ), # 1
    (2, TType.STRING, 'ztmk', None, None, ), # 2
  )

  def __init__(self, code=None, ztmk=None,):
    self.code = code
    self.ztmk = ztmk
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('ZTmk')
    if self.code is not None:
      oprot.writeFieldBegin('code', TType.I32, 1)
      oprot.writeI32(self.code)
      oprot.writeFieldEnd()
    if self.ztmk is not None:
      oprot.writeFieldBegin('ztmk', TType.STRING, 2)
      oprot.writeString(self.ztmk)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
