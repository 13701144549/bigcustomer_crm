...
class GoodsInfo:
  ...
  thrift_spec = (
    ...
    (16, TType.STRING, 'goods_attr', None, None, ), # 16
  )

  def __init__(self, goodsid=None, goodsname=None, goodsprice=None, goodscnt=None, menuid=None, menuname=None, menutype=None, picaddr=None, unionid=None, goodsinfo=None, descr=None, goodsspec=None, mchnt_id=None, weight=None, goodsorgprice=None, goods_attr=None,):
    self.goodsid = goodsid
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.goods_attr = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.goodsorgprice is not None:
      ...
      oprot.writeFieldEnd()
    if self.goods_attr is not None:
      oprot.writeFieldBegin('goods_attr', TType.STRING, 16)
      oprot.writeString(self.goods_attr)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.goods_attr)
    return value
...
class OrderPayInfo:
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'pay_type', None, None, ), # 4
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.pay_type = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.pay_type is not None:
      oprot.writeFieldBegin('pay_type', TType.STRING, 4)
      oprot.writeString(self.pay_type)
      oprot.writeFieldEnd()
...
class OrderInfo:
  ...
  thrift_spec = (
    ...
    (20, TType.I32, 'distribution', None, None, ), # 20
    (21, TType.STRING, 'coupon_code', None, None, ), # 21
  )

  def __init__(self, mchnt_id=None, customer_id=None, source=None, goodsinfo=None, addr=None, amt=None, busicd=None, order_type=None, state=None, note=None, open_id=None, order_name=None, print_state=None, order_id=None, order_sn=None, ctime=None, appid=None, shipping_fee=None, addr_id=None, distribution=None, coupon_code=None,):
    self.mchnt_id = mchnt_id
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I32:
          self.distribution = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.distribution is not None:
      oprot.writeFieldBegin('distribution', TType.I32, 20)
      oprot.writeI32(self.distribution)
      oprot.writeFieldEnd()
    if self.coupon_code is not None:
      oprot.writeFieldBegin('coupon_code', TType.STRING, 21)
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.distribution)
