...
class Iface:
  ...
  def getactRecordsBysyssns(self, syssns):
    """
    Parameters:
     - syssns
    """
...
class Client(Iface):
  ...
  def getactRecordsBysyssns(self, syssns):
    ...
    Parameters:
     - syssns
    """
    self.send_getactRecordsBysyssns(syssns)
    return self.recv_getactRecordsBysyssns()

  def send_getactRecordsBysyssns(self, syssns):
    self._oprot.writeMessageBegin('getactRecordsBysyssns', TMessageType.CALL, self._seqid)
    args = getactRecordsBysyssns_args()
    args.syssns = syssns
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getactRecordsBysyssns(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getactRecordsBysyssns_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.e is not None:
      raise result.e
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getactRecordsBysyssns failed: unknown result")
  ...
  def getMchntid(self, mcht):
    ...
    Parameters:
     - mcht
    """
    self.send_getMchntid(mcht)
    return self.recv_getMchntid()

  def send_getMchntid(self, mcht):
    self._oprot.writeMessageBegin('getMchntid', TMessageType.CALL, self._seqid)
    args = getMchntid_args()
    args.mcht = mcht
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getMchntid(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
    ...
    if result.e is not None:
      raise result.e
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getMchntid failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getactRecordsBysyssns"] = Processor.process_getactRecordsBysyssns
    self._processMap["getMchntid"] = Processor.process_getMchntid
  ...
  def process_getactRecordsBysyssns(self, seqid, iprot, oprot):
    args = getactRecordsBysyssns_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getactRecordsBysyssns_result()
    try:
      result.success = self._handler.getactRecordsBysyssns(args.syssns)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except ServerException as e:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getactRecordsBysyssns", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getMchntid(self, seqid, iprot, oprot):
    args = getMchntid_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getMchntid_result()
    try:
      result.success = self._handler.getMchntid(args.mcht)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except ServerException as e:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getMchntid", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class getactRecordsBysyssns_args:
  """
  Attributes:
   - syssns
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'syssns', (TType.STRING,None), None, ), # 1
  )

  def __init__(self, syssns=None,):
    self.syssns = syssns
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getactRecordsBysyssns_args')
    if self.syssns is not None:
      oprot.writeFieldBegin('syssns', TType.LIST, 1)
      oprot.writeListBegin(TType.STRING, len(self.syssns))
      for iter163 in self.syssns:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.syssns)
    return value
...
class getactRecordsBysyssns_result:
  """
  Attributes:
   - success
   - e
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING,None,TType.STRUCT,(AccountRecord, AccountRecord.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'e', (ServerException, ServerException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getactRecordsBysyssns_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.MAP, 0)
...
class getMchntid_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'mcht', (MerchantNumPara, MerchantNumPara.thrift_spec), None, ), # 1
  )

  def __init__(self, mcht=None,):
    self.mcht = mcht
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.mcht = MerchantNumPara()
          self.mcht.read(iprot)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getMchntid_args')
    if self.mcht is not None:
      oprot.writeFieldBegin('mcht', TType.STRUCT, 1)
      self.mcht.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getMchntid_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getMchntid_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success)
      oprot.writeFieldEnd()
