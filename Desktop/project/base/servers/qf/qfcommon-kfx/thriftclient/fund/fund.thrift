...
service FundService{
    ...
    //通过交易流水号来获取对账表详细
    map<string, AccountRecord> getactRecordsBysyssns(1:list<string> syssns) throws(1:ServerException e),

    //获取实名商户号。
    string getMchntid(1: MerchantNumPara mcht) throws(1:ServerException e),
}
