...
class PayDownload:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'stime', None, None, ), # 2
    (3, TType.STRING, 'etime', None, None, ), # 3
    (4, TType.STRING, 'state', None, None, ), # 4
  )

  def __init__(self, bat_id=None, stime=None, etime=None, state=None,):
    self.bat_id = bat_id
    self.stime = stime
    self.etime = etime
    self.state = state
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.stime = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
          self.etime = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('PayDownload')
    if self.bat_id is not None:
      oprot.writeFieldBegin('bat_id', TType.STRING, 1)
      oprot.writeString(self.bat_id)
      oprot.writeFieldEnd()
    if self.stime is not None:
      oprot.writeFieldBegin('stime', TType.STRING, 2)
      oprot.writeString(self.stime)
      oprot.writeFieldEnd()
    if self.etime is not None:
      oprot.writeFieldBegin('etime', TType.STRING, 3)
      oprot.writeString(self.etime)
      oprot.writeFieldEnd()
...
class WithDrawArgs:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'withdraw_sn', None, None, ), # 2
    (3, TType.I32, 'amt', None, None, ), # 3
    (4, TType.I64, 'userid', None, None, ), # 4
  )

  def __init__(self, biz_sn=None, withdraw_sn=None, amt=None, userid=None,):
    self.biz_sn = biz_sn
    self.withdraw_sn = withdraw_sn
    self.amt = amt
    self.userid = userid
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.withdraw_sn = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.biz_sn is not None:
      ...
      oprot.writeFieldEnd()
    if self.withdraw_sn is not None:
      oprot.writeFieldBegin('withdraw_sn', TType.STRING, 2)
      oprot.writeString(self.withdraw_sn)
      oprot.writeFieldEnd()
    if self.amt is not None:
      oprot.writeFieldBegin('amt', TType.I32, 3)
  ...
  def validate(self):
    ...
    if self.withdraw_sn is None:
      raise TProtocol.TProtocolException(message='Required field withdraw_sn is unset!')
    if self.amt is None:
      raise TProtocol.TProtocolException(message='Required field amt is unset!')
    if self.userid is None:
      raise TProtocol.TProtocolException(message='Required field userid is unset!')
