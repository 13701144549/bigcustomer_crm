...
class Iface:
  ...
  def get_can_transfer_byaccount(self, ):
    pass

  def get_withdraw_info(self, ):
    pass

  def gen_withdraw_record(self, arg, rule):
    """
    Parameters:
     - arg
     - rule
  ...
  def add_supplement_record(self, userid, amt, reason, account_type):
    """
    Parameters:
     - userid
     - amt
  ...
  def generate_payanother_excel(self, params):
    """
    Parameters:
     - params
    """
...
class Client(Iface):
  ...
  def send_get_can_transfer(self, txcurrcd):
    ...
    self._oprot.trans.flush()
  def get_can_transfer_byaccount(self, ):
    self.send_get_can_transfer_byaccount()

  def send_get_can_transfer_byaccount(self, ):
    self._oprot.writeMessageBegin('get_can_transfer_byaccount', TMessageType.CALL, self._seqid)
    args = get_can_transfer_byaccount_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()
  def get_withdraw_info(self, ):
  ...
  def gen_withdraw_record(self, arg, rule):
    ...
    Parameters:
     ...
     - rule
    """
    self.send_gen_withdraw_record(arg, rule)

  def send_gen_withdraw_record(self, arg, rule):
  ...
  def add_supplement_record(self, userid, amt, reason, account_type):
    ...
    Parameters:
     ...
     - account_type
    """
    self.send_add_supplement_record(userid, amt, reason, account_type)
    return self.recv_add_supplement_record()

  def send_add_supplement_record(self, userid, amt, reason, account_type):
  ...
  def generate_payanother_excel(self, params):
    ...
    Parameters:
     - params
    """
    self.send_generate_payanother_excel(params)

  def send_generate_payanother_excel(self, params):
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["get_can_transfer_byaccount"] = Processor.process_get_can_transfer_byaccount
  ...
  def process_get_can_transfer_byaccount(self, seqid, iprot, oprot):
    args = get_can_transfer_byaccount_args()
    args.read(iprot)
    iprot.readMessageEnd()
    self._handler.get_can_transfer_byaccount()
    return
  ...
  def process_gen_withdraw_record(self, seqid, iprot, oprot):
    ...
    args.read(iprot)
    iprot.readMessageEnd()
    self._handler.gen_withdraw_record(args.arg, args.rule)
    return
  ...
  def process_add_supplement_record(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = add_supplement_record_result()
    result.success = self._handler.add_supplement_record(args.userid, args.amt, args.reason, args.account_type)
  ...
  def process_generate_payanother_excel(self, seqid, iprot, oprot):
    ...
    args.read(iprot)
    iprot.readMessageEnd()
    self._handler.generate_payanother_excel(args.params)
    return
...
class get_can_transfer_byaccount_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_can_transfer_byaccount_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class gen_withdraw_record_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'arg', (TType.STRUCT,(WithDrawArgs, WithDrawArgs.thrift_spec)), None, ), # 1
    (2, TType.STRING, 'rule', None, None, ), # 2
  )

  def __init__(self, arg=None, rule=None,):
    self.arg = arg
    self.rule = rule
  ...
  def write(self, oprot):
    ...
    if self.arg is not None:
      ...
      for iter6 in self.arg:
        iter6.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.rule is not None:
      oprot.writeFieldBegin('rule', TType.STRING, 2)
      oprot.writeString(self.rule)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class add_supplement_record_args:
  ...
  thrift_spec = (
    ...
    (4, TType.I64, 'account_type', None, None, ), # 4
  )

  def __init__(self, userid=None, amt=None, reason=None, account_type=None,):
    self.userid = userid
    self.amt = amt
    self.reason = reason
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.account_type = iprot.readI64();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.account_type is not None:
      oprot.writeFieldBegin('account_type', TType.I64, 4)
      oprot.writeI64(self.account_type)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def validate(self):
    ...
    if self.account_type is None:
      raise TProtocol.TProtocolException(message='Required field account_type is unset!')
    return
...
class generate_payanother_excel_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'params', (PayDownload, PayDownload.thrift_spec), None, ), # 1
  )
