...
class TemplateSend:
  ...
  thrift_spec = (
    ...
    (6, TType.I16, 'type', None, 0, ), # 6
    (7, TType.STRING, 'form_id', None, None, ), # 7
    (8, TType.STRING, 'ext', None, None, ), # 8
  )

  def __init__(self, appid=None, openid=None, template_id=None, url=thrift_spec[4][4], data=None, type=thrift_spec[6][4], form_id=None, ext=None,):
    self.appid = appid
    self.openid = openid
  ...
  def write(self, oprot):
    ...
    if self.form_id is not None:
      oprot.writeFieldBegin('form_id', TType.STRING, 7)
      oprot.writeString(self.form_id)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.form_id)
