...
class AccountInfo:
  ...
  thrift_spec = (
    ...
    (3, TType.DOUBLE, 'wechat_fee', None, None, ), # 3
    (4, TType.DOUBLE, 'alipay_fee', None, None, ), # 4
  ...
  def __init__(self, settle_cycle=None, settle_base_amt=None, wechat_fee=None, alipay_fee=None, jd_fee=None, qqwallet_fee=None, swipecard_fee=None, default_mchnt_fee=None, royalty_rule_id=None,):
    self.settle_cycle = settle_cycle
    self.settle_base_amt = settle_base_amt
    self.wechat_fee = wechat_fee
    self.alipay_fee = alipay_fee
    self.jd_fee = jd_fee
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.DOUBLE:
          self.wechat_fee = iprot.readDouble()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.DOUBLE:
          self.alipay_fee = iprot.readDouble()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.DOUBLE:
  ...
  def write(self, oprot):
    ...
    if self.settle_base_amt is not None:
      ...
      oprot.writeFieldEnd()
    if self.wechat_fee is not None:
      oprot.writeFieldBegin('wechat_fee', TType.DOUBLE, 3)
      oprot.writeDouble(self.wechat_fee)
      oprot.writeFieldEnd()
    if self.alipay_fee is not None:
      oprot.writeFieldBegin('alipay_fee', TType.DOUBLE, 4)
      oprot.writeDouble(self.alipay_fee)
      oprot.writeFieldEnd()
  ...
  def validate(self):
    ...
    if self.wechat_fee is None:
      raise TProtocol.TProtocolException(message='Required field wechat_fee is unset!')
    if self.alipay_fee is None:
      raise TProtocol.TProtocolException(message='Required field alipay_fee is unset!')
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.wechat_fee)
    value = (value * 31) ^ hash(self.alipay_fee)
