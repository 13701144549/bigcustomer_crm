...
class PrepaidRecord:
  ...
  thrift_spec = (
    ...
    (13, TType.I64, 'fund_uid', None, None, ), # 13
  )

  def __init__(self, cid=None, userid=None, biz_sn=None, syssn=None, status=None, biz_type=None, txamt=None, pay_amt=None, present_amt=None, orig_biz_sn=None, activity_id=None, sysdtm=None, fund_uid=None,):
    self.cid = cid
    self.userid = userid
    self.biz_sn = biz_sn
    self.syssn = syssn
  ...
  def write(self, oprot):
    ...
    if self.sysdtm is not None:
      ...
      oprot.writeFieldEnd()
    if self.fund_uid is not None:
      oprot.writeFieldBegin('fund_uid', TType.I64, 13)
      oprot.writeI64(self.fund_uid)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class BalanceInfo:
  ...
  thrift_spec = (
    ...
    (7, TType.STRING, 'id', None, None, ), # 7
    (8, TType.STRING, 'update_time', None, None, ), # 8
  )

  def __init__(self, cid=None, userid=None, balance=None, first_use_dtm=None, last_recharge_dtm=None, last_consume_dtm=None, id=None, update_time=None,):
    self.cid = cid
    self.userid = userid
  ...
  def validate(self):
    ...
    if self.update_time is None:
      raise TProtocol.TProtocolException(message='Required field update_time is unset!')
    return
...
class OPPrepaidBalanceArg:
  ...
  thrift_spec = (
    ...
    (6, TType.I64, 'fund_uid', None, None, ), # 6
  )

  def __init__(self, cid=None, userid=None, txamt=None, biz_type=None, memo=None, fund_uid=None,):
    self.cid = cid
    self.userid = userid
    self.txamt = txamt
    self.biz_type = biz_type
  ...
  def write(self, oprot):
    ...
    if self.memo is not None:
      ...
      oprot.writeFieldEnd()
    if self.fund_uid is not None:
      oprot.writeFieldBegin('fund_uid', TType.I64, 6)
      oprot.writeI64(self.fund_uid)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
